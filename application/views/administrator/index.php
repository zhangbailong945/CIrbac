...
<head>
    <title>CodeIgniter权限管理系统</title>
    <link href="<?php echo $liger_Path;?>lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" />  
    <link rel="stylesheet" type="text/css" id="mylink"/>   
    <script src="<?php echo $liger_Path;?>lib/jquery/jquery-1.9.0.min.js" type="text/javascript"></script>    
    <script src="<?php echo $liger_Path;?>lib/ligerUI/js/ligerui.all.js" type="text/javascript"></script>  
    <script src="<?php echo $liger_Path;?>lib/jquery.cookie.js"></script>
    <script src="<?php echo $liger_Path;?>lib/json2.js"></script>
    <script src="<?php echo $liger_Path;?>lib/indexdata.js" type="text/javascript"></script>
        <script type="text/javascript">
            ...
            var skin_links = {
                "aqua": "<?php echo $liger_Path;?>lib/ligerUI/skins/Aqua/css/ligerui-all.css",
                "gray": "<?php echo $liger_Path;?>lib/ligerUI/skins/Gray/css/all.css",
                "silvery": "<?php echo $liger_Path;?>lib/ligerUI/skins/Silvery/css/style.css",
                "gray2014": "<?php echo $liger_Path;?>lib/ligerUI/skins/gray2014/css/all.css"
            };
            function pages_init()
            {
...
<style type="text/css"> 
    ...
    .space{ color:#E7E7E7;}
    /* 顶部 */ 
    .l-topmenu{ margin:0; padding:0; height:31px; line-height:31px; background:url('<?php echo $liger_Path;?>lib/images/top.jpg') repeat-x bottom;  position:relative; border-top:1px solid #1D438B;  }
    .l-topmenu-logo{ color:#E7E7E7; padding-left:35px; line-height:26px;background:url('<?php echo $liger_Path;?>lib/images/topicon.gif') no-repeat 10px 5px;}
